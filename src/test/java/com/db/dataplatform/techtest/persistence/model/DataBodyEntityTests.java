...
import static com.db.dataplatform.techtest.TestDataHelper.getMD5Hash;
...
public class DataBodyEntityTests {
    ...
    public void assignDataBodyEntityFieldsShouldWorkAsExpected() {
        ...
        dataBodyEntity.setDataBodyChecksum(getMD5Hash(dataBodyEntity.getDataBody()));

        assertThat(dataBodyEntity.getDataHeaderEntity()).isNotNull();
        assertThat(dataBodyEntity.getDataBody()).isNotNull();
        assertThat(dataBodyEntity.getDataBodyChecksum()).isEqualTo(getMD5Hash(dataBodyEntity.getDataBody()));
    }
